...
from detector.views import TextInputView, download_file
...
urlpatterns = [
    ...
    path(
        "asdas", TemplateView.as_view(template_name="pages/landing_real.html"), name="landing2"
    ),
    ...
    path('download/', download_file, name='download_file'),  # Add this line
